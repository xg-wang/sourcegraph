...
import { SignupEmailField } from './SignipEmailField'
...
export const SignUpForm: React.FunctionComponent<SignUpFormProps> = ({
    ...
    const onClickExternalAuthSignup = useCallback(
        (type: 'github' | 'gitlab'): React.MouseEventHandler<HTMLAnchorElement> => () => {
                        ...
                        {externalAuthProviders.map((provider, index) => (
                            ...
                            <div className="mb-2" key={index}>
                                <a
                                    ...
                                    onClick={onClickExternalAuthSignup(provider.serviceType as 'github' | 'gitlab')}
                                >
